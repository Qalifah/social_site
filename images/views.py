...
def image_detail(request, id, slug):
    ...
    return render(request, 'images/image_detail.html', {'section': 'images', 'image': image, 'total_views': total_views})
...
def image_ranking(request):
    ...
    return render(request, 'images/image_ranking.html', {'section': 'images', 'most_viewed': most_viewed})